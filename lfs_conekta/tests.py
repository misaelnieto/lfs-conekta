...
#from lfs_conekta.models import PayPalOrderTransaction

import conketa

class ConketaPaymentTestCase(TestCase):
    """
        Tests conekta payments
    """
    fixtures = ['lfs_shop.xml']

    def _monkeyPatch(self):
        "Monkeypatches conekta"

    def setUp(self):

        self.llave_privada = "key_vzizCJY9ccPtvXKs"
        self.llave_publica = "key_dv5Kjchdaskj674s"
